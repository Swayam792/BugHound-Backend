...
export const getBugs = async (req: Request, res: Response) => {
    ...
    const bugs = await bugRepository.createQueryBuilder('bug')
...
export const createBug = async (req: Request, res: Response) => {
    ...
    const relationedBug = await bugRepository.createQueryBuilder('bug')
...
export const updateBug = async (req: Request, res: Response) => {
    ...
    const targetBug = await bugRepository.findOne({
        where: {
            id: bugId
        }
    });
...
export const deleteBug = async (req: Request, res: Response) => {
  const { projectId, bugId } = req.params as any;
  ...
  await noteRepository.delete({ bugId });
...
export const reopenBug = async (req: Request, res: Response) => {
    ...
    const targetBug = await bugRepository.findOne({ where: {
        id: bugId
    }});
